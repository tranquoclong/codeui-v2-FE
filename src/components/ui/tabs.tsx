...
function TabsList({ className, ...props }: React.ComponentProps<typeof TabsPrimitive.List>) {
  return (
    <TabsPrimitive.List
      data-slot='tabs-list'
      className={cn(
        'inline-flex h-10 w-fit items-center justify-center rounded-lg bg-neutral-800 p-[3px]',
        className
      )}
      {...props}
    />
